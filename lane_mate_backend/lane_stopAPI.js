...
app.post("/lane_stops", async (req, res) => {
  try {
    const { quote_request_id, city_id, is_origin } = req.body;
    console.log(req.body);
    const newLane_stop = await pool.query(
      "INSERT INTO lane_stops (quote_request_id, city_id, is_origin) VALUES ($1, $2, $3) RETURNING *",
      [quote_request_id, city_id, is_origin]
    );
